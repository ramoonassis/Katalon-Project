...
WebUI.click(findTestObject('Page_CURA Healthcare Service/Medicare Input 1'))

WebUI.click(findTestObject('Page_CURA Healthcare Service/Comment Input'))

WebUI.setText(findTestObject('Page_CURA Healthcare Service/Comment Input'), 'Agendamento para meu avô')
...
WebUI.click(findTestObject('Page_CURA Healthcare Service/Menu_Sanduiche'))

WebUI.click(findTestObject('Page_CURA Healthcare Service/History Button'))

WebUI.verifyTextPresent('Agendamento para meu avô', false)
