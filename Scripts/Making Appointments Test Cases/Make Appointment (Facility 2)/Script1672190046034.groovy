...
WebUI.selectOptionByValue(findTestObject('Page_CURA Healthcare Service/Facility Tab'), 'Hongkong CURA Healthcare Center', 
    false)

WebUI.click(findTestObject('Page_CURA Healthcare Service/Apply Readmission Tag'))

WebUI.click(findTestObject('Page_CURA Healthcare Service/Medicaid Input 2'))
